...
(*.[0-9]*)
	...
	if test ! -f "/home/xingqiankun/workspace/c_workspace/terminal_music/ext/ncurses-6.4/man_alias.sed" ; then
cat >>/home/xingqiankun/workspace/c_workspace/terminal_music/ext/ncurses-6.4/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/xingqiankun/workspace/c_workspace/terminal_music/ext/ncurses-6.4/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/home/xingqiankun/workspace/c_workspace/terminal_music/ext/ncurses-6.4/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	...
	sed	-f "/home/xingqiankun/workspace/c_workspace/terminal_music/ext/ncurses-6.4/man_alias.sed" \
		< "$i" >$TMP
